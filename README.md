...
自`v2024.03.30.1528`版本开始，汉化安装器可以自动将放置于`l10n_installer/mods/`目录的po或mo文件应用到即将被安装的汉化包。
...
2. 运行汉化安装器，在提示“是否将`l10n_installer/mods/`下的模组应用到汉化文件？”时输入Y后按回车键，等待安装器将汉化修改包应用到即将被安装的汉化包。
